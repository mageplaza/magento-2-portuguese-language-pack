...
2. [Install Portuguese Language Pack](#2-how-to-install-hungarian-language-pack)
3. [How to active Portuguese language pack](#3-how-to-active-hungarian-language-pack)
...
## 3. How to active Portuguese language pack {#active}
