...
- This file [crowdin_pull.csv](https://github.com/mageplaza/magento-2-portuguese-language-pack/blob/master/crowdin_pull.csv) has been pulled from [Crowdin](https://crowdin.com/project/magento-2) daily, so you should not change/edit the file.
